sudo pacman -S ntfs-3g pacakge-query abs dmenu xorg-xinit xorg-xsetroot xorg-server xf86-video-ati \
	pcmanfm devmon xorg-xrdb feh oxygen-gtk2 oxygen-gtk3 lxappearance oxygen-icons terminus-font \
	alsa-utils chromium upower ttf-bitstream-vera mixxx tor vidalia cmus git gstreamer0.10-base-plugins \
